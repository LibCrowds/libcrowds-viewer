...
import ViewerControls from '@/components/controls/types/Viewer'
import PanControls from '@/components/controls/types/Pan'
import ZoomControls from '@/components/controls/types/Zoom'
