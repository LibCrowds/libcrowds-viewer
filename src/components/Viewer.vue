...
import ViewerControls from '@/components/types/items/Viewer'
import PanControls from '@/components/types/items/Pan'
import ZoomControls from '@/components/types/items/Zoom'
